...
WebUI.setText(findTestObject('Object Repository/Page_Striven/input_Sign in_ctl00ctl00mainContentmainCont_755761'), '1234')

WebUI.click(findTestObject('Object Repository/Page_Striven/input_Email Activation_ctl00ctl00mainConten_95bee1'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Striven/div_Your email address or password is incor_e950e2'), 
    'Your email address or password is incorrect. Please try again.')

WebUI.rightClick(findTestObject('Object Repository/Page_Striven/input_Sign in_ctl00ctl00mainContentmainCont_755761'))
